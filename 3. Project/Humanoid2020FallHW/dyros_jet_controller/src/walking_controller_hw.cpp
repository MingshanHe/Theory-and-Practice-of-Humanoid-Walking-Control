  ...
  if((walking_enable_ == true))
  {
    ...
    if(ready_for_compute_flag_ == true)
    {
      ...
      {          
        ...
        // rfoot_trajectory_float_.translation()(0) = 0.5 * lfoot_trajectory_support_.translation()(0);
        // rfoot_trajectory_float_.translation()(1) = -0.12782;
        // rfoot_trajectory_float_.translation()(2) = -0.76548 + 0.5* lfoot_trajectory_support_.translation()(2);

        // lfoot_trajectory_float_.translation()(0) = 0.2 * rfoot_trajectory_support_.translation()(0);
        // lfoot_trajectory_float_.translation()(1) =  0.12782;
        // lfoot_trajectory_float_.translation()(2) = -0.76548 + 0.5 * lfoot_trajectory_support_.translation()(2);
...
// {
//   double Cx1, Cx2, w_n, T, td, Kx,B;
//   td = t_double1_/hz_;
//   T = t_total_/hz_;
//   w_n = sqrt(9.80665/0.721854);

//   // double B = zmp_desired_(0);
  

//   if(current_step_num_ == 0 ) 
//   {
//     /* Drive initial X-ZMP to zero */
//     com_desired_(0) = ref_zmp_(walking_tick_,0);
//     B = ref_zmp_(walking_tick_,0);
...
//     {
//       /* DSP */
//       com_desired_(0) = ref_zmp_(walking_tick_ - t_start_, 0) + current_step_num_*0 ;
//       B = ref_zmp_(walking_tick_ - t_start_, 0) + current_step_num_*0 ;
//       // cout<<"B:"<<B<<endl;
//     } 
...
//       com_desired_(0) = Cx2*cosh((walking_tick_-t_start_ - t_double1_)/hz_)+ Cx1*sinh((walking_tick_-t_start_ - t_double1_)/hz_) + B ;



//       cout <<walking_tick_<<","<<
//       Kx<<","<<Cx1<<","<<Cx2<<","<<w_n<<","<<
//       tanh(w_n*(T/2-t_double1_))<<","<<cosh(w_n*(walking_tick_-t_start_ - t_double1_)/hz_)<<","<<
//       sinh(w_n*(walking_tick_-t_start_ - t_double1_)/hz_)<<","<<
//       com_desired_(0)<< ","<<hz_<<endl;
...
//   if (!com_data.is_open()) 
//   {
//     com_data.open("/home/robot/humanoid_ws/src/Humanoid2020FallHW/data/com_data.csv", std::ios::app);
//   }
//   com_data << walking_tick_ << "," << current_step_num_ << "," << com_desired_(0)<<","<< com_desired_(1)<<  std::endl;
